...
protected_map_fn(row_n = 4, rast_agg_fact = 2)
```
...
slopes_map_fn(row_n = 4, rast_agg_fact = 2)
```
...
roads_map_fn(row_n = 4, rast_agg_fact = 2)
```
...
riparian_map_fn(row_n = 4, rast_agg_fact = 2)
######## export image
# ggplot2::ggsave(
...
administrative_map_fn(row_n = 4, rast_agg_fact = 2)
```
...
treatable_map_fn(row_n = 4, rast_agg_fact = 2)
######## export image
ggplot2::ggsave(
