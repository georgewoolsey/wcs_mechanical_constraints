...
cowplot::ggdraw(
  plt_fpas_sc_map[[2]] + 
    ...
    theme(legend.position = c(.15,.98), legend.direction = "horizontal")
  ) +
  cowplot::draw_plot(inset_temp, .55, .6, .3, .35) +
